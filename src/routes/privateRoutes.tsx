...
const AnalyzePack = lazy(() => import('../pages/short-urls/pack-chain/AnalyzePack'));
const PreConfiguredLevel = lazy(() => import('../pages/short-urls/pack-chain/PreConfiguredLevel'));
...
export const privateRoutes: RouteConfig[] = [
  ...
  {
    path: PATHS.PRIVATE.PRE_CONFIGURED_LEVEL,
    element: <PreConfiguredLevel />,
  },
];
